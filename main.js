...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".modal-background{\n    background-color: rgba(10, 10, 10, 50%);\n    position: absolute;\n    top: 0;\n    height: 100%;\n    width: 100%;\n}\n\n.task-modal, .project-modal{\n    background-color: white;\n    display: flex;\n    flex-direction: column;\n    position: absolute;\n    top: 20%;\n    left: 20%;\n    height: 50%;\n    width: 50%;\n}\n\n.task-modal .modal-header, .project-modal, .modal-header{\n    display: flex;\n    justify-content: space-between;\n}\n\n.task-modal .modal-body, .project-modal, .modal-body{\n    flex: 1;\n}\n\n.task-modal .modal-body{\n    display: grid;\n    grid-template-columns: 1fr 1fr;\n}\n\n.task-modal .modal-body > [class*=\"wrapper\"]{\n    display: flex;\n    flex-direction: column;\n}\n\n.task-modal .modal-footer, .project-modal .modal-footer{\n    display: flex;\n    justify-content: flex-end;\n}\n\n.invalid{\n    outline: solid 2px red;\n}\n\n.valid{\n    outline: solid 2px lightgreen;\n}", "",{"version":3,"sources":["webpack://./src/modals.css"],"names":[],"mappings":"AAAA;IACI,uCAAuC;IACvC,kBAAkB;IAClB,MAAM;IACN,YAAY;IACZ,WAAW;AACf;;AAEA;IACI,uBAAuB;IACvB,aAAa;IACb,sBAAsB;IACtB,kBAAkB;IAClB,QAAQ;IACR,SAAS;IACT,WAAW;IACX,UAAU;AACd;;AAEA;IACI,aAAa;IACb,8BAA8B;AAClC;;AAEA;IACI,OAAO;AACX;;AAEA;IACI,aAAa;IACb,8BAA8B;AAClC;;AAEA;IACI,aAAa;IACb,sBAAsB;AAC1B;;AAEA;IACI,aAAa;IACb,yBAAyB;AAC7B;;AAEA;IACI,sBAAsB;AAC1B;;AAEA;IACI,6BAA6B;AACjC","sourcesContent":[".modal-background{\n    background-color: rgba(10, 10, 10, 50%);\n    position: absolute;\n    top: 0;\n    height: 100%;\n    width: 100%;\n}\n\n.task-modal, .project-modal{\n    background-color: white;\n    display: flex;\n    flex-direction: column;\n    position: absolute;\n    top: 20%;\n    left: 20%;\n    height: 50%;\n    width: 50%;\n}\n\n.task-modal .modal-header, .project-modal, .modal-header{\n    display: flex;\n    justify-content: space-between;\n}\n\n.task-modal .modal-body, .project-modal, .modal-body{\n    flex: 1;\n}\n\n.task-modal .modal-body{\n    display: grid;\n    grid-template-columns: 1fr 1fr;\n}\n\n.task-modal .modal-body > [class*=\"wrapper\"]{\n    display: flex;\n    flex-direction: column;\n}\n\n.task-modal .modal-footer, .project-modal .modal-footer{\n    display: flex;\n    justify-content: flex-end;\n}\n\n.invalid{\n    outline: solid 2px red;\n}\n\n.valid{\n    outline: solid 2px lightgreen;\n}"],"sourceRoot":""}]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root{\n    --nav-height: 44px;\n    --aside-height: calc(100vh - var(--nav-height));\n    --aside-width: 305px;\n}\n\nhtml, body{\n    margin: 0;\n    box-sizing: border-box;\n    outline: solid red 1px;\n}\n\nbody{\n    background-color: teal;\n}\n\nnav{\n    background-color: grey;\n    height: 44px;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n}\n\nnav #hamburger-toggle{\n    cursor: pointer;\n}\n\nnav #new-task-button{\n    cursor: pointer;\n}\n\n.wrapper{\n    display: flex;\n}\n\naside{\n    background-color: aqua;\n    height: var(--aside-height);\n    width: 0;\n    transition: width 0.2s ease-in;\n}\n\naside.active{\n    width: var(--aside-width);\n}\n\naside .projects.hidden{\n    display: none;\n}\n\naside .new-project-button{\n    display: flex;\n    align-items: center;\n}\n\naside .project{\n    display: flex;\n    cursor: pointer;\n    background-color: darksalmon;\n}\n\naside .project:hover{\n    background-color: darkred;\n}\n\naside .project.current{\n    font-weight: 900;\n    background-color: darkred;\n}\n\nmain{\n    flex: 1;\n    background-color: pink;\n}\n\nmain .project-tasks{\n    height: 100%;\n    overflow-y: scroll;\n    display: flex;\n    flex-direction: column;\n}\n\n.project-tasks .task{\n    display: flex;\n    cursor: pointer;\n}\n\n.project-tasks .task-details{\n    background-color: red;\n}\n\n.project-tasks .task-details.collapsed{\n    display: none;\n    /* ESTO DEBERIA CRECER EN HEIGHT, NO DESAPARECER */\n}\n\n.project-tasks .task #priority-toggle.low{\n    color: yellow;\n}\n\n.project-tasks .task #priority-toggle.medium{\n    color: green;\n}\n\n.project-tasks .task #priority-toggle.high{\n    color: red;\n}\n\n.done{\n    opacity: 0.5;\n    text-decoration: line-through;\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,kBAAkB;IAClB,+CAA+C;IAC/C,oBAAoB;AACxB;;AAEA;IACI,SAAS;IACT,sBAAsB;IACtB,sBAAsB;AAC1B;;AAEA;IACI,sBAAsB;AAC1B;;AAEA;IACI,sBAAsB;IACtB,YAAY;IACZ,aAAa;IACb,mBAAmB;IACnB,8BAA8B;AAClC;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,sBAAsB;IACtB,2BAA2B;IAC3B,QAAQ;IACR,8BAA8B;AAClC;;AAEA;IACI,yBAAyB;AAC7B;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,eAAe;IACf,4BAA4B;AAChC;;AAEA;IACI,yBAAyB;AAC7B;;AAEA;IACI,gBAAgB;IAChB,yBAAyB;AAC7B;;AAEA;IACI,OAAO;IACP,sBAAsB;AAC1B;;AAEA;IACI,YAAY;IACZ,kBAAkB;IAClB,aAAa;IACb,sBAAsB;AAC1B;;AAEA;IACI,aAAa;IACb,eAAe;AACnB;;AAEA;IACI,qBAAqB;AACzB;;AAEA;IACI,aAAa;IACb,kDAAkD;AACtD;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,UAAU;AACd;;AAEA;IACI,YAAY;IACZ,6BAA6B;AACjC","sourcesContent":[":root{\n    --nav-height: 44px;\n    --aside-height: calc(100vh - var(--nav-height));\n    --aside-width: 305px;\n}\n\nhtml, body{\n    margin: 0;\n    box-sizing: border-box;\n    outline: solid red 1px;\n}\n\nbody{\n    background-color: teal;\n}\n\nnav{\n    background-color: grey;\n    height: 44px;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n}\n\nnav #hamburger-toggle{\n    cursor: pointer;\n}\n\nnav #new-task-button{\n    cursor: pointer;\n}\n\n.wrapper{\n    display: flex;\n}\n\naside{\n    background-color: aqua;\n    height: var(--aside-height);\n    width: 0;\n    transition: width 0.2s ease-in;\n}\n\naside.active{\n    width: var(--aside-width);\n}\n\naside .projects.hidden{\n    display: none;\n}\n\naside .new-project-button{\n    display: flex;\n    align-items: center;\n}\n\naside .project{\n    display: flex;\n    cursor: pointer;\n    background-color: darksalmon;\n}\n\naside .project:hover{\n    background-color: darkred;\n}\n\naside .project.current{\n    font-weight: 900;\n    background-color: darkred;\n}\n\nmain{\n    flex: 1;\n    background-color: pink;\n}\n\nmain .project-tasks{\n    height: 100%;\n    overflow-y: scroll;\n    display: flex;\n    flex-direction: column;\n}\n\n.project-tasks .task{\n    display: flex;\n    cursor: pointer;\n}\n\n.project-tasks .task-details{\n    background-color: red;\n}\n\n.project-tasks .task-details.collapsed{\n    display: none;\n    /* ESTO DEBERIA CRECER EN HEIGHT, NO DESAPARECER */\n}\n\n.project-tasks .task #priority-toggle.low{\n    color: yellow;\n}\n\n.project-tasks .task #priority-toggle.medium{\n    color: green;\n}\n\n.project-tasks .task #priority-toggle.high{\n    color: red;\n}\n\n.done{\n    opacity: 0.5;\n    text-decoration: line-through;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
function _appendProjectModal({mode, project}){
    ...
    _modals_data__WEBPACK_IMPORTED_MODULE_4__.FA_ICONS.forEach(fontAwesomeIcon => {
...
function appendDeleteProjectModal(project){
...
function _updateTask(task){
    ...
    (0,_projects__WEBPACK_IMPORTED_MODULE_2__.logProject)(task.project);
...
function _moveTask(task, recipientProject){
    const taskAlreadyExists = (0,_projects__WEBPACK_IMPORTED_MODULE_2__.getProjectTasks)(recipientProject)[task.title];
...
function _deleteProject(project){
    (0,_projects__WEBPACK_IMPORTED_MODULE_2__.deleteProject)(project);
    (0,_ui__WEBPACK_IMPORTED_MODULE_3__.reloadProjects)();
...
class ToDo{
    constructor({title, description, priority, dueDate, project}){
        ...
        (0,_projects__WEBPACK_IMPORTED_MODULE_0__.addTaskToProject)(this, project);
    }
    ...
    moveTo(newProject){
        (0,_projects__WEBPACK_IMPORTED_MODULE_0__.deleteTaskFromProject)(this);
        this.project = newProject;
        (0,_projects__WEBPACK_IMPORTED_MODULE_0__.addTaskToProject)(this, newProject);
    }
...
function _appendAside(container){
    ...
    const ASIDE_COMPONENTS = {
        inbox: {
            ...
            iconClasses: ["fa-solid", (0,_projects__WEBPACK_IMPORTED_MODULE_2__.getProjectIcon)("Inbox").class],
            eventListeners: [
...
function _displayTasks(projectName){
    ...
    const tasks = (isTodaysTasks) ? (0,_projects__WEBPACK_IMPORTED_MODULE_2__.getTodaysTasks)() : (isThisWeeksTasks) ? (0,_projects__WEBPACK_IMPORTED_MODULE_2__.getThisWeeksTasks)() : (0,_projects__WEBPACK_IMPORTED_MODULE_2__.getProjectTasks)(projectName);
