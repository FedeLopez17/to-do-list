...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root{\n    --nav-height: 44px;\n    --full-viewport-height-minus-nav-height: calc(100vh - var(--nav-height));\n    --aside-width: 305px;\n    --amount-of-projects: 0;\n    --aside-projects-height: 40px;\n    --new-project-button-height: 50px;\n    --aside-projects-toggle-height: 40px;\n    --aside-projectlist-projects-margin-bottom: 20px;\n}\n\nhtml, body{\n    margin: 0;\n    box-sizing: border-box;\n}\n\nbody{\n    background-color: teal;\n    overflow-x: hidden;\n}\n\n.wrapper{\n    height: var(--full-viewport-height-minus-nav-height);\n    display: flex;\n    position: relative;\n}\n\n/* Navbar */\nnav{\n    background-color: grey;\n    height: var(--nav-height);\n    display: flex;\n    align-items: center;\n}\n\nnav #hamburger-toggle{\n    margin-left: 10px;\n    cursor: pointer;\n}\n\nnav #page-title{\n    margin-left: 20px;\n    margin-right: auto;\n}\n\nnav #new-task-button{\n    margin-right: 10px;\n    cursor: pointer;\n}\n\n\n/* Aside section */\n.aside-background{\n    display: none;\n    position: absolute;\n    width: 100%;\n    height: 100vh;\n    top: calc(var(--nav-height) * -1);\n    background-color: rgba(10, 10, 10, 30%);\n    z-index: 1;\n}\n\naside{\n    background-color: aqua;\n    height: 100%;\n    width: 0;\n    transition: width 0.2s ease-in;\n    box-sizing: border-box;\n    padding: 50px 0;\n    overflow-y: auto;\n    overflow-x: hidden;\n    z-index: 1;\n}\n\naside.active{\n    width: var(--aside-width);\n}\n\naside *{\n    white-space: nowrap;\n}\n\n/* Aside Projects */\n\naside .projects{\n    height: calc(((var(--aside-projects-height) + var(--aside-projectlist-projects-margin-bottom)) * var(--amount-of-projects)) + var(--new-project-button-height));\n    transition: height 0.3s;\n    background-color: royalblue;\n    overflow: hidden;\n}\n\naside .projects.hidden{\n    height: 0px;\n}\n\naside .project{\n    height: var(--aside-projects-height);\n    margin-left: 25px;\n    margin-right: 5px;\n    display: flex;\n    justify-content: flex-start;\n    align-items: center;\n    cursor: pointer;\n}\n\naside .project > i{\n    margin-left: 10px;\n    margin-right: 10px;\n}\n\naside .project:hover{\n    background-color: darkred;\n}\n\naside .project.current{\n    font-weight: 900;\n    background-color: darkred;\n}\n\naside .project-list{\n    margin: 20px 5px 0 35px;\n    border-top: solid 1px red;\n}\n\naside #project-toggle{\n    height: var(--aside-projects-toggle-height);\n    display: flex;\n    align-items: center;\n    cursor: pointer;\n}\n\naside #project-toggle i{\n    margin-left: 10px;\n}\n\naside .project-list .project{\n    margin-left: 0;\n    margin-bottom: var(--aside-projectlist-projects-margin-bottom);\n    background-color: aliceblue;\n}\n\naside .project-list .project .project-title-wrapper{\n    display: flex;\n    gap: 5px;\n    width: 70%;\n}\n\naside .project-list .project .project-title-wrapper span{\n    overflow: hidden;\n    text-overflow: ellipsis;\n}\n\n\naside .project-list .project .project-title-wrapper i{\n    margin-left: 0;\n}\n\naside .project-list .project i{\n    margin-right: 0;\n    margin-left: 10px;\n}\n\naside .new-project-button{\n    height: var(--new-project-button-height);\n    display: flex;\n    align-items: center;\n    gap: 5px;\n    cursor: pointer;\n    margin-right: 5px;\n}\n\n\n/* Main section*/\nmain{\n    width: calc(100% - var(--aside-width));\n    flex: 1;\n    display: flex;\n    justify-content: center;\n    background-color: pink;\n}\n\nmain .project-tasks{\n    width: 100%;\n    box-sizing: border-box;\n    overflow-y: auto;\n    padding: 0 10%;\n    display: flex;\n    flex-direction: column;\n    background-color: red;\n}\n\n.project-tasks .task{\n    display: flex;\n    flex-direction: column;\n    margin-bottom: 20px;\n    cursor: pointer;\n}\n\n.project-tasks .task .top{\n    height: 50px;\n    display: flex;\n    align-items: center;\n    background-color: pink;\n    border-radius: 10px 10px 0 0;\n}\n\n.project-tasks .task .top.low{\n    outline: solid 1px yellow;\n}\n\n.project-tasks .task .top.medium{\n    outline: solid 1px green;\n}\n\n.project-tasks .task .top.high{\n    outline: solid 1px red;\n}\n\n.project-tasks .task .top .status-checkbox{\n    margin: 0 10px;\n    cursor: pointer;\n}\n\n.project-tasks .task .top .task-title{\n    margin-right: auto;\n    max-width: 25ch;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n}\n\n.project-tasks .task .top.done .task-title{\n    text-decoration: line-through;\n}\n\n.project-tasks:not([data-project-name=\"Completed\"]) .task .top.done{\n    opacity: 0.5;\n    outline: solid 1px skyblue;\n}\n\n.project-tasks .task .top i{\n    margin-right: 10px;\n}\n\n.project-tasks .task-details{\n    height: 190px;\n    transition: height 0.2s;\n    overflow-x: auto;\n    overflow-y: hidden;\n    background-color: white;\n    border-radius: 0 0 10px 10px;\n    display: grid;\n    grid-template-columns: 1fr;\n    align-content: space-evenly;\n    padding: 0 10%;\n}\n\n.project-tasks .task-details p{\n    margin: 0;\n}\n\n.project-tasks .task-details p > span{\n    font-weight: 900;\n}\n\n.project-tasks .task-details.collapsed{\n    height: 0;\n}\n\n.project-tasks .task #priority-toggle.low{\n    color: yellow;\n}\n\n.project-tasks .task #priority-toggle.medium{\n    color: green;\n}\n\n.project-tasks .task #priority-toggle.high{\n    color: red;\n}\n\n.project-tasks #add-task-button{\n    height: 50px;\n    margin-bottom: 50px;\n    display: flex;\n    align-items: center;\n    gap: 5px;\n    cursor: pointer;\n}\n\n@media (max-width: 700px), (orientation: portrait){\n    aside{\n        position: absolute;\n    }\n\n    .aside-background.active{\n        display: block;\n    }\n\n    .task #move-task-button, .task #priority-toggle{\n        display: none;\n    }\n\n    .project-tasks .task .top .task-title{\n        max-width: 20ch;\n    }\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,kBAAkB;IAClB,wEAAwE;IACxE,oBAAoB;IACpB,uBAAuB;IACvB,6BAA6B;IAC7B,iCAAiC;IACjC,oCAAoC;IACpC,gDAAgD;AACpD;;AAEA;IACI,SAAS;IACT,sBAAsB;AAC1B;;AAEA;IACI,sBAAsB;IACtB,kBAAkB;AACtB;;AAEA;IACI,oDAAoD;IACpD,aAAa;IACb,kBAAkB;AACtB;;AAEA,WAAW;AACX;IACI,sBAAsB;IACtB,yBAAyB;IACzB,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,iBAAiB;IACjB,eAAe;AACnB;;AAEA;IACI,iBAAiB;IACjB,kBAAkB;AACtB;;AAEA;IACI,kBAAkB;IAClB,eAAe;AACnB;;;AAGA,kBAAkB;AAClB;IACI,aAAa;IACb,kBAAkB;IAClB,WAAW;IACX,aAAa;IACb,iCAAiC;IACjC,uCAAuC;IACvC,UAAU;AACd;;AAEA;IACI,sBAAsB;IACtB,YAAY;IACZ,QAAQ;IACR,8BAA8B;IAC9B,sBAAsB;IACtB,eAAe;IACf,gBAAgB;IAChB,kBAAkB;IAClB,UAAU;AACd;;AAEA;IACI,yBAAyB;AAC7B;;AAEA;IACI,mBAAmB;AACvB;;AAEA,mBAAmB;;AAEnB;IACI,+JAA+J;IAC/J,uBAAuB;IACvB,2BAA2B;IAC3B,gBAAgB;AACpB;;AAEA;IACI,WAAW;AACf;;AAEA;IACI,oCAAoC;IACpC,iBAAiB;IACjB,iBAAiB;IACjB,aAAa;IACb,2BAA2B;IAC3B,mBAAmB;IACnB,eAAe;AACnB;;AAEA;IACI,iBAAiB;IACjB,kBAAkB;AACtB;;AAEA;IACI,yBAAyB;AAC7B;;AAEA;IACI,gBAAgB;IAChB,yBAAyB;AAC7B;;AAEA;IACI,uBAAuB;IACvB,yBAAyB;AAC7B;;AAEA;IACI,2CAA2C;IAC3C,aAAa;IACb,mBAAmB;IACnB,eAAe;AACnB;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,cAAc;IACd,8DAA8D;IAC9D,2BAA2B;AAC/B;;AAEA;IACI,aAAa;IACb,QAAQ;IACR,UAAU;AACd;;AAEA;IACI,gBAAgB;IAChB,uBAAuB;AAC3B;;;AAGA;IACI,cAAc;AAClB;;AAEA;IACI,eAAe;IACf,iBAAiB;AACrB;;AAEA;IACI,wCAAwC;IACxC,aAAa;IACb,mBAAmB;IACnB,QAAQ;IACR,eAAe;IACf,iBAAiB;AACrB;;;AAGA,gBAAgB;AAChB;IACI,sCAAsC;IACtC,OAAO;IACP,aAAa;IACb,uBAAuB;IACvB,sBAAsB;AAC1B;;AAEA;IACI,WAAW;IACX,sBAAsB;IACtB,gBAAgB;IAChB,cAAc;IACd,aAAa;IACb,sBAAsB;IACtB,qBAAqB;AACzB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,mBAAmB;IACnB,eAAe;AACnB;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,mBAAmB;IACnB,sBAAsB;IACtB,4BAA4B;AAChC;;AAEA;IACI,yBAAyB;AAC7B;;AAEA;IACI,wBAAwB;AAC5B;;AAEA;IACI,sBAAsB;AAC1B;;AAEA;IACI,cAAc;IACd,eAAe;AACnB;;AAEA;IACI,kBAAkB;IAClB,eAAe;IACf,gBAAgB;IAChB,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,6BAA6B;AACjC;;AAEA;IACI,YAAY;IACZ,0BAA0B;AAC9B;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,uBAAuB;IACvB,gBAAgB;IAChB,kBAAkB;IAClB,uBAAuB;IACvB,4BAA4B;IAC5B,aAAa;IACb,0BAA0B;IAC1B,2BAA2B;IAC3B,cAAc;AAClB;;AAEA;IACI,SAAS;AACb;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,SAAS;AACb;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,UAAU;AACd;;AAEA;IACI,YAAY;IACZ,mBAAmB;IACnB,aAAa;IACb,mBAAmB;IACnB,QAAQ;IACR,eAAe;AACnB;;AAEA;IACI;QACI,kBAAkB;IACtB;;IAEA;QACI,cAAc;IAClB;;IAEA;QACI,aAAa;IACjB;;IAEA;QACI,eAAe;IACnB;AACJ","sourcesContent":[":root{\n    --nav-height: 44px;\n    --full-viewport-height-minus-nav-height: calc(100vh - var(--nav-height));\n    --aside-width: 305px;\n    --amount-of-projects: 0;\n    --aside-projects-height: 40px;\n    --new-project-button-height: 50px;\n    --aside-projects-toggle-height: 40px;\n    --aside-projectlist-projects-margin-bottom: 20px;\n}\n\nhtml, body{\n    margin: 0;\n    box-sizing: border-box;\n}\n\nbody{\n    background-color: teal;\n    overflow-x: hidden;\n}\n\n.wrapper{\n    height: var(--full-viewport-height-minus-nav-height);\n    display: flex;\n    position: relative;\n}\n\n/* Navbar */\nnav{\n    background-color: grey;\n    height: var(--nav-height);\n    display: flex;\n    align-items: center;\n}\n\nnav #hamburger-toggle{\n    margin-left: 10px;\n    cursor: pointer;\n}\n\nnav #page-title{\n    margin-left: 20px;\n    margin-right: auto;\n}\n\nnav #new-task-button{\n    margin-right: 10px;\n    cursor: pointer;\n}\n\n\n/* Aside section */\n.aside-background{\n    display: none;\n    position: absolute;\n    width: 100%;\n    height: 100vh;\n    top: calc(var(--nav-height) * -1);\n    background-color: rgba(10, 10, 10, 30%);\n    z-index: 1;\n}\n\naside{\n    background-color: aqua;\n    height: 100%;\n    width: 0;\n    transition: width 0.2s ease-in;\n    box-sizing: border-box;\n    padding: 50px 0;\n    overflow-y: auto;\n    overflow-x: hidden;\n    z-index: 1;\n}\n\naside.active{\n    width: var(--aside-width);\n}\n\naside *{\n    white-space: nowrap;\n}\n\n/* Aside Projects */\n\naside .projects{\n    height: calc(((var(--aside-projects-height) + var(--aside-projectlist-projects-margin-bottom)) * var(--amount-of-projects)) + var(--new-project-button-height));\n    transition: height 0.3s;\n    background-color: royalblue;\n    overflow: hidden;\n}\n\naside .projects.hidden{\n    height: 0px;\n}\n\naside .project{\n    height: var(--aside-projects-height);\n    margin-left: 25px;\n    margin-right: 5px;\n    display: flex;\n    justify-content: flex-start;\n    align-items: center;\n    cursor: pointer;\n}\n\naside .project > i{\n    margin-left: 10px;\n    margin-right: 10px;\n}\n\naside .project:hover{\n    background-color: darkred;\n}\n\naside .project.current{\n    font-weight: 900;\n    background-color: darkred;\n}\n\naside .project-list{\n    margin: 20px 5px 0 35px;\n    border-top: solid 1px red;\n}\n\naside #project-toggle{\n    height: var(--aside-projects-toggle-height);\n    display: flex;\n    align-items: center;\n    cursor: pointer;\n}\n\naside #project-toggle i{\n    margin-left: 10px;\n}\n\naside .project-list .project{\n    margin-left: 0;\n    margin-bottom: var(--aside-projectlist-projects-margin-bottom);\n    background-color: aliceblue;\n}\n\naside .project-list .project .project-title-wrapper{\n    display: flex;\n    gap: 5px;\n    width: 70%;\n}\n\naside .project-list .project .project-title-wrapper span{\n    overflow: hidden;\n    text-overflow: ellipsis;\n}\n\n\naside .project-list .project .project-title-wrapper i{\n    margin-left: 0;\n}\n\naside .project-list .project i{\n    margin-right: 0;\n    margin-left: 10px;\n}\n\naside .new-project-button{\n    height: var(--new-project-button-height);\n    display: flex;\n    align-items: center;\n    gap: 5px;\n    cursor: pointer;\n    margin-right: 5px;\n}\n\n\n/* Main section*/\nmain{\n    width: calc(100% - var(--aside-width));\n    flex: 1;\n    display: flex;\n    justify-content: center;\n    background-color: pink;\n}\n\nmain .project-tasks{\n    width: 100%;\n    box-sizing: border-box;\n    overflow-y: auto;\n    padding: 0 10%;\n    display: flex;\n    flex-direction: column;\n    background-color: red;\n}\n\n.project-tasks .task{\n    display: flex;\n    flex-direction: column;\n    margin-bottom: 20px;\n    cursor: pointer;\n}\n\n.project-tasks .task .top{\n    height: 50px;\n    display: flex;\n    align-items: center;\n    background-color: pink;\n    border-radius: 10px 10px 0 0;\n}\n\n.project-tasks .task .top.low{\n    outline: solid 1px yellow;\n}\n\n.project-tasks .task .top.medium{\n    outline: solid 1px green;\n}\n\n.project-tasks .task .top.high{\n    outline: solid 1px red;\n}\n\n.project-tasks .task .top .status-checkbox{\n    margin: 0 10px;\n    cursor: pointer;\n}\n\n.project-tasks .task .top .task-title{\n    margin-right: auto;\n    max-width: 25ch;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n}\n\n.project-tasks .task .top.done .task-title{\n    text-decoration: line-through;\n}\n\n.project-tasks:not([data-project-name=\"Completed\"]) .task .top.done{\n    opacity: 0.5;\n    outline: solid 1px skyblue;\n}\n\n.project-tasks .task .top i{\n    margin-right: 10px;\n}\n\n.project-tasks .task-details{\n    height: 190px;\n    transition: height 0.2s;\n    overflow-x: auto;\n    overflow-y: hidden;\n    background-color: white;\n    border-radius: 0 0 10px 10px;\n    display: grid;\n    grid-template-columns: 1fr;\n    align-content: space-evenly;\n    padding: 0 10%;\n}\n\n.project-tasks .task-details p{\n    margin: 0;\n}\n\n.project-tasks .task-details p > span{\n    font-weight: 900;\n}\n\n.project-tasks .task-details.collapsed{\n    height: 0;\n}\n\n.project-tasks .task #priority-toggle.low{\n    color: yellow;\n}\n\n.project-tasks .task #priority-toggle.medium{\n    color: green;\n}\n\n.project-tasks .task #priority-toggle.high{\n    color: red;\n}\n\n.project-tasks #add-task-button{\n    height: 50px;\n    margin-bottom: 50px;\n    display: flex;\n    align-items: center;\n    gap: 5px;\n    cursor: pointer;\n}\n\n@media (max-width: 700px), (orientation: portrait){\n    aside{\n        position: absolute;\n    }\n\n    .aside-background.active{\n        display: block;\n    }\n\n    .task #move-task-button, .task #priority-toggle{\n        display: none;\n    }\n\n    .project-tasks .task .top .task-title{\n        max-width: 20ch;\n    }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
